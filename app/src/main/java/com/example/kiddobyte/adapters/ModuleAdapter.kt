...
class ModuleAdapter (private val context: Activity, private val dataList: ArrayList<Module>, private val itemClickListener: OnItemClickListener): RecyclerView.Adapter<ModuleAdapter.MyViewHolder>() {
